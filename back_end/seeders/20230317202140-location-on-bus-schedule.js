		...
		return queryInterface.bulkInsert("location_on_bus_schedule", [
			{
				bus_schedule_id: 2,
				bus_detail:
					'["Văn Phòng Mỹ Đình: 11:30","Văn Phòng Giáp Bát: 11:45", "Bến Xe Nước Ngầm: 12:15" ,"Văn Phòng Thanh Xuân:  12:45"]',
			...
			// 	bus_schedule_id: 2,
			// 	bus_detail:
			// 		'["Văn Phòng Nam Định: 13:30", "Văn Phòng Lê Hồng Phong: 13:50" , Văn Phòng Nghĩa Hưng: 14:20]',
			// 	bus_location_address:
			...
			},
			{
				bus_schedule_id: 2,
				bus_detail:
					'["Nghĩa Trang Mai Dịch: 09:20" , "Công Viên Cầu Giấy: 09:45" , "Văn Phòng Trần Vỹ: 10:08"]',
				bus_location_address:
