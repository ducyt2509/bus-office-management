    ...
    ? location_pickup.map((location, index) => {
        return (
          <>
            ...
            {props.transportData.number_seat_selected.filter(
              (e) =>
              ...
              props.transportData.number_seat_selected
                ...
                .map((e) => {
                  return (
                    <Box border="1px solid" padding={'15px 8%'} marginBottom={'10px'}>
                      <Flex
                      ...
                      >
                        <Stack w="60%">
                          <Text marginBottom={'5px'}>Khách hàng: {e.passenger_name}</Text>
