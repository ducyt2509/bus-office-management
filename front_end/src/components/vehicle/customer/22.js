...
export default function Seat22(props) {
	...
	const SteeringHTML = (
		<Image
			src={Steering}
			style={{ cursor: "pointer", width: "25%", marginLeft: "10%" }}
		/>
	);
	return (
        ...
        width="50%"
			>
      <Text position="absolute" bottom="13%" marginLeft="4%">Tầng 1</Text>
        ...
        width="50%"
			>
      <Text position="absolute" bottom="13%" marginLeft="4%">Tầng 2</Text>
				<Flex marginBottom="8%">
					<Image
						src={Steering}
						style={{ cursor: "pointer", width: "25%", opacity: 0 }}
					/>
				</Flex>
				<Flex
					justifyContent={"space-between"}
