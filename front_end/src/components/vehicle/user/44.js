...
export default function Seat44User(props) {
  const seatVehicle = [
    'A1',
    'A2',
    'A3',
        ...
        <CardBody margin={'0 auto'} w="100%">
          <Box>
            ...
            <Flex justifyContent="space-around">
              ...
              <Flex className="bom-admin">{seatHTML('G4')}</Flex>
              <Flex className="bom-admin">{seatHTML('G5')}</Flex>
            </Flex>
          </Box>
        </CardBody>
      </Card>
        ...
        <CardBody margin={'0 auto'} w="100%">
          <Box>
            ...
            <Flex justifyContent="space-around">
              ...
              <Flex className="bom-admin">{seatHTML('O4')}</Flex>
              <Flex className="bom-admin">{seatHTML('O5')}</Flex>
            </Flex>
          </Box>
        </CardBody>
      </Card>
