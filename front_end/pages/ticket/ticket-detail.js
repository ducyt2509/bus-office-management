...
export default function TicketDetail(props) {
  ...
  return (
    <>
      <Flex w="80%" margin={'3% auto 2%'} justifyContent="space-between" flexWrap="wrap">
        <Box flexBasis={{ base: '100%', lg: '37%' }} marginBottom={'2%'}>
          <Text fontSize={'20px'} fontWeight="500" marginBottom={'2%'}>
            Chi tiết vé
          </Text>
          <Card border={'1px solid'} paddingLeft={'5%'} paddingRight={'5%'}>
            <CardBody>
              <Stack divider={<StackDivider />} spacing="3">
                <Box>
                  ...
                  <Text fontWeight={'500'} marginBottom={'3%'}>
        ...
        <Box flexBasis={{ base: '100%', lg: '60%' }}>
          ...
          <Card border={'1px solid'} marginTop={'1%'}>
            <CardBody>
              <Flex justifyContent={'space-between'}>
                <Stack spacing="5">
                  <Box>
                    ...
                    <Text fontSize={'14px'} color="#686868" marginBottom={'3%'}>
                      Ghế ngồi
                    </Text>
                    <Text marginBottom={'8%'} fontWeight={'500'}>
                      {props.data?.seat}
                    </Text>
                    <Text fontSize={'14px'} color="#686868" marginBottom={'3%'}>
                      Mã vé
                ...
                {props.data?.vehicle_type_id == 1 ? (
                  <Seat12
                    ...
                    page="ticket detail"
                  />
                ) : props.data?.vehicle_type_id == 2 ? (
                  <Seat22
                    seatSelected={seatSelected}
                    setSeatSelected={setSeatSelected}
                    page="ticket detail"
                  />
                ) : props.data?.vehicle_type_id == 3 ? (
                  <Seat38
                    seatSelected={seatSelected}
                    setSeatSelected={setSeatSelected}
                    page="ticket detail"
                  />
                ) : props.data?.vehicle_type_id == 4 ? (
                  <Seat40
                    seatSelected={seatSelected}
                    setSeatSelected={setSeatSelected}
                    page="ticket detail"
                  />
                ) : props.data?.vehicle_type_id == 5 ? (
                  <Seat44
                    seatSelected={seatSelected}
                    setSeatSelected={setSeatSelected}
                    page="ticket detail"
