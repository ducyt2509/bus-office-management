					...
					<ModalBody>
						{props.vehicleId != 0 && (
							...
							>
								...
								<Switch
									size="lg"
									isChecked={vehicleStatus}
									onChange={handleChangeVehicleStatus}
								/>
							</Flex>
						)}
						<FormControl
							isRequired
							isInvalid={error.vehiclePlate}
							marginBottom={"5%"}
						>
							<Flex>
								<FormLabel
								...
								<Input
									value={vehiclePlate}
									onChange={handleChangeVehiclePlate}
								/>
							</Flex>
