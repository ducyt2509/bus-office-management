    ...
    <>
      <Box borderTop="1px solid #E2E8F0" borderBottom="1px solid #E2E8F0" margin="3% 0">
        <Flex margin="5% 0  " alignItems={'center'} justifyContent="space-around">
          <Stack>
            <Flex alignItems={'center'} marginBottom="10% !important">
              <Image src={EmptyChair} style={{ width: '25%', maxHeight: '50px !important' }} />
              <Text marginLeft={'10%'} whiteSpace="nowrap" color="#7d7d7d" fontWeight={'500'}>
                Ghế còn trống
              </Text>
            </Flex>
            <Flex alignItems={'center'} marginBottom="10% !important">
              <Image src={SoldChair} style={{ width: '25%', maxHeight: '50px !important' }} />
              <Text marginLeft={'10%'} whiteSpace="nowrap" color="#7d7d7d" fontWeight={'500'}>
                Ghế đã bán
              </Text>
            </Flex>
            <Flex alignItems={'center'} marginBottom="10% !important">
              <Image src={SelectChair} style={{ width: '25%', maxHeight: '50px !important' }} />
              <Text marginLeft={'10%'} whiteSpace="nowrap" color="#7d7d7d" fontWeight={'500'}>
                Ghế bạn chọn
              </Text>
            </Flex>
          </Stack>
          {props.data.vehicle_id == 1 && (
