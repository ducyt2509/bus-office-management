          ...
          <CardBody>
            <Stack divider={<StackDivider />} spacing="5">
                ...
                <Flex justifyContent={'space-between'}>
                  ...
                  <Flex flexDirection={'column'} justifyContent={'space-between'}>
                    ...
                    <Text
                      ...
                      marginBottom={'3%'}
                    >
                      {vehicle?.bus[0]?.vehicle_type_name} - {vehicle?.bus[0]?.vehicle_plate}
                    </Text>
                    <Flex alignItems={'flex-end'}>
                      ...
                      <Button
                        color={'#fff'}
                        backgroundColor={status[index]?.status != 'book' ? '#F26A4C' : '#7D7D7D'}
                        padding="0 40px"
              ...
              {status[index]?.status == 'book' && (
                <BusScheduleBookTicket data={vehicle} busScheduleInformation={props.data} />
              )}
            </Stack>
          </CardBody>
        </Card>
