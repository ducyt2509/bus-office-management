        ...
        <ModalContent>
          ...
          <ModalBody>
            <FormControl marginBottom={'5%'} isRequired isInvalid={error.officeName}>
              <Flex>
                <FormLabel marginBottom="0" width={'51.5%'} fontWeight={'500'} mt={'2'}>
                  Tên văn phòng
                </FormLabel>
            ...
            <FormControl marginBottom={'5%'} isRequired isInvalid={error.city}>
              <Flex>
                <FormLabel marginBottom="0" width={'50%'} fontWeight={'500'} mt={'2'}>
                  Tỉnh/Thành phố
                </FormLabel>
            ...
            <FormControl marginBottom={'5%'} isRequired isInvalid={error.office}>
              <Flex>
                <FormLabel width={'51.5%'} fontWeight={'500'}>
                  Địa chỉ
                </FormLabel>
                <Textarea value={office} onChange={handleChangeOffice} />
              </Flex>
          ...
          <ModalFooter justifyContent={'space-around'}>
            ...
            <Button backgroundColor="#F26A4C" color="#fff" onClick={handleAddOffice}>
