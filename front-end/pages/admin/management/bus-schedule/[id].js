		...
		async (id) => {
			try {
				...
				if (getBusScheduleById) {
					...
					let date_start = new Date(dataBusSchedule.effective_date)
						.toISOString()
						.split("T")[0];
			...
			<div style={{ width: "90%", margin: "0 auto" }}>
				...
				>
					<CardBody>
						...
						<Box>
							<FormControl
								isInvalid={error.departureLocationId}
								isRequired
							>
								<Box display={"flex"}>
						...
						<Box>
							<FormControl
								isInvalid={error.arriveLocationId}
								isRequired
							>
								<Box display={"flex"}>
						...
						<Box>
							<FormControl
								isInvalid={error.scheduleFrequency}
								isRequired
							>
								<Box display={"flex"}>
						...
						<Box>
							<FormControl
								isInvalid={error.scheduleExpire}
								isRequired
							>
								<Box display={"flex"}>
