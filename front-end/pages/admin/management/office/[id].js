...
export default function Employee(props) {
  ...
  const getOfficeDetail = async () => {
    const officeDetail = await axios.post(
  ...
  return (
    <div style={{ position: 'relative', left: '20%', width: '80%' }}>
      ...
      <Card
        ...
        marginTop={'2%'}
      >
        <div style={{ width: '60%', backgroundColor: '#000' }}>
          <Image
            width={'80%'}
            margin={'0 auto'}
            minHeight={'500px'}
        ...
        <CardBody>
          ...
          <Flex alignItems={'center'} marginTop="5%">
            ...
            <Text fontSize={'20px'} fontWeight="500" marginLeft="1%">
              Địa chỉ:{' '}
            </Text>
            <Text fontSize={'20px'} marginLeft="3%">
